...
test_mod = math.lcm(*[monkey.test for monkey in monkeys])
...
for _ in range(ROUNDS):
    for monkey in monkeys:
        for worry_level in monkey.items:
            ...
            worry_level = ((worry_level % test_mod) * (op_value % test_mod) % test_mod) if monkey.operation == '*' else worry_level + op_value
